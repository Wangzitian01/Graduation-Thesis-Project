						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>
									...
									<select name="baseDictLevel.dictId" style="WIDTH: 180px">
										<!-- 此处从Action获得集合数据遍历即可 -->
							...
							<TR>
								...
								<td>信息来源 ：</td>
								<td>
									<select name="baseDictSource.dictId" style="WIDTH: 180px">
								...
								<td>所属行业 ：</td>
								<td>
									<select name="baseDictIndustry.dictId" style="WIDTH: 180px">
