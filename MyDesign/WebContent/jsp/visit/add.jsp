...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/visistAction_add"
		method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>客户名称：</td>
								<td>
									<select name="customer.custId" onchange="changeCustomer(this)" style="WIDTH: 182px;height:20px">
								...
								<td>业务员 ：</td>
								<td>
									<select name="user.userId" style="WIDTH: 182px;height:20px">
							...
							<TR>
								...
								<INPUT class=textbox id="visit_time" readonly="readonly"
														style="WIDTH: 180px" maxLength=50 name="visitTime">
								</td>
								<td>拜访地点 ：</td>
								<td>
							...
							<TR>
								...
								<td>拜访详情 ：</td>
								<td>
									<textarea rows="5" cols="25" name="visitDetail"></textarea>
								</td>
								<td></td>
								<td></td>
							</TR>
