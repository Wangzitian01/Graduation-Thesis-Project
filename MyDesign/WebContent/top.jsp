							...
							<TBODY>
								...
								<TR>
									<TD height=35 align="right">
										当前用户：${user.userName}
										&nbsp;&nbsp;&nbsp;&nbsp;
										<A href="edit.jsp" target=_top><FONT color=red>修改密码</FONT></A>
										&nbsp;&nbsp;&nbsp;&nbsp;
										
										<!-- javascript:void(0)"阻止后续继续运行  可以让href属性失效 -->
										<A href="javascript:void(0)" target=_top onclick="loginout()"><FONT color=red>安全退出</FONT></A>
