									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/customerAction_addUI" target=main>－ 新增客户</A>
													</TD>
												</TR>
												<TR> 
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/customerAction_list" target=main>－ 客户列表</A>
													</TD>
												</TR>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/linkmanAction_addUI" target=main>－ 新增联系人</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/linkmanAction_findByCondition" target=main>－联系人列表</A>
													</TD>
												</TR>
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/visitAction_addUI" target=main>－新增客户拜访</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/visitAction_list" target=main>－客户拜访列表</A></TD>
												</TR>
